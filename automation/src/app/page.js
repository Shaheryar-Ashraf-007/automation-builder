...
export default function Home() {
  return (
    <main className="flex items-center justify-center flex-col">
          ...
          <ContainerScroll
            titleComponent={
              <div className="flex items-center flex-col">
                ...
                <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl bg-clip-text text-transparent bg-gradient-to-b from-white to-neutral-600 font-sans font-bold text-center">
                  Automate Your Work With Automix
                </h1>
              </div>
            }
          />
      ...
      <InfiniteMovingCards
        className="md:mt-[38rem] mt-[250px]"
        items={clients}
        direction="right"
        speed="slow"
      />
